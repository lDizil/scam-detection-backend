            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.ToggleUserStatusRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AnalyzeURLRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/handlers.AnalyzeURLResponse"
                        }
                    },
                    "400": {
        ...
        "/analysis/video": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Видео (MP4, AVI, MOV, MKV, WEBM). Макс: 50MB, 5 минут",
                        "name": "video",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Результат анализа видео",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Невалидный файл или превышен лимит",
                        "schema": {
                            "$ref": "#/definitions/handlers.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "handlers.AnalyzeURLRequest": {
            ...
            "properties": {
                "url": {
                    "type": "string",
                    "example": "https://example-phishing.com"
                }
            }
        },
        "handlers.AnalyzeURLResponse": {
            "type": "object",
            "properties": {
                "check_id": {
                    "type": "integer"
        ...
        "handlers.ToggleUserStatusRequest": {
            "type": "object",
            "required": [
                "is_active"
            ],
